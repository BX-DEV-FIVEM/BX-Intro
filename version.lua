...
if Config.CheckUpdate then
    ...
    CreateThread(function()
        ...
        local versionUrl = 'https://raw.githubusercontent.com/BX-DEV-FIVEM/BX-Intro/main/version.lua'
        ...
        PerformHttpRequest(versionUrl, function(error, result, headers)
            ...
            if currentVersion ~= latestVersion then
                ...
                print("  || ^5   https://github.com/BX-DEV-FIVEM/BX-Intro ^0\n  \\\\")
            else
                print("  //\n  || ^1   " .. resourceName .. "^0 from ^5BX-DEV^0")
    ...
    AddEventHandler('onResourceStart', function(resourceName)
        if GetCurrentResourceName() ~= expectedResourceName then
            print("^1  Ressource Name must be 'BX-Intro' ^0")
        end
